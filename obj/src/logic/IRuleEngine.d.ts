...
export interface IRuleEngine {
     ...
     */
    verifyRule(rule: Rule, facts: IVariableCollection, conditionFunctions: IFunctionCollection, actionFunctions: IFunctionCollection, callback: (err: any) => void): any;
    /**
     ...
     * @param callback a callback that returns the test result.
     */
    testRule(rule: Rule, facts: IVariableCollection, conditionFunctions: IFunctionCollection, callback: (err: any, result: boolean) => void): any;
    /**
     ...
     */
    testFirstRule(rules: Rule[], facts: IVariableCollection, conditionFunctions: IFunctionCollection, callback: (err: any, rule: Rule) => void): any;
    /**
     ...
     */
    testAllRules(rules: Rule[], facts: IVariableCollection, conditionFunctions: IFunctionCollection, callback: (err: any, rules: Rule[]) => void): any;
    /**
     ...
     */
    actUponRule(rule: Rule, facts: IVariableCollection, actionFunctions: IFunctionCollection, callback: (err: any, result: any) => void): any;
    /**
     ...
     */
    actUponAllRules(rules: Rule[], facts: IVariableCollection, actionFunctions: IFunctionCollection, callback: (err: any, results: any[]) => void): any;
}
